...
The provided flag is Base64 encoded. And after decrypting the result is  _Thr33_
...
After getting into the folder “don’t know”, we find a png named mysterybox, which appears to be another zipped png. And yes indeed it is, and the password is “cuteCAT”. Using Zsteg and binwalk we extract the folder to get the flag part 1
